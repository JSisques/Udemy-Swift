 ...
 */
//Usamos la palabra reservada final para indicar que una propiedad o funcion no se puede modificar
...
// La palabra override se utiliza para sobrescribir el metodo, variable o cualquier cosa de la clase padre
class Car : Vehicle{
    var manufacturer = ""
    var model = ""
